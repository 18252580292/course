    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        courseViewHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("url", HttpConstants.BASE_URL + courseBean.getCourse().get(position).getUrl());
                bundle.putString("name", courseBean.getCourse().get(position).getName());
                intent.putExtra("bundle", bundle);
                mContext.startActivity(intent);
            }
        });
//        courseViewHolder.cardView.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(mContext, PlayActivity.class);
//                Bundle bundle = new Bundle();
