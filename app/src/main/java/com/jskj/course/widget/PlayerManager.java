package com.jskj.course.widget;
...
import com.jskj.course.util.DebugLog;
import com.jskj.course.widget.media.AndroidMediaController;
import com.jskj.course.widget.media.IRenderView;
import com.jskj.course.widget.media.IjkVideoView;
...
//                      Toast.show("download rate:" + extra);
        ...
        videoView.setMediaController(new AndroidMediaController(activity));
